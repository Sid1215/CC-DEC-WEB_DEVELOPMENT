...
property[20] = "Data Transfer Rate";
unit[20] = new Array("Bit/second", "Kilobit/second", "Kilobyte/second", "Kibibit/second", "Megabit/second","Megabyte/second", "Mebibit/second","Gigabit/second","Gigabyte/second","Gigibit/second","Terabit/second","Terabyte/second","Tebibit/second");
factor[20] = new Array(1, 1000, 8000, 1024,  1e+6, 8e+6, 1.049e+6, 1e+9, 8e+9, 1.074e+9, 1e+12, 8e+12,  1.1e+12);
...
function ConvertFromTo(sourceForm, targetForm) {
  ...
  // b) use the targetFactor to convert FROM the base unit
  // to the target unit...
...
// Restricting textboxes to accept numbers and the navigational keys only
